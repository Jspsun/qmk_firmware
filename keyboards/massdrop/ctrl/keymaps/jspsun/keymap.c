...
enum ctrl_keycodes {
    ...
    GAMER,                 //epic gamer mode for epic gamers (locks layer at 0)
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_BRID, KC_BRIU, KC_F13,  KC_F14,  RGB_VAD,  RGB_VAI,  KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU,         XXXXXXX, RGB_TOG,   TG(2), \
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   LT(1, KC_SPC),                      KC_LGUI, MO(1),   KC_APP,            KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        KC_ESC,  KC_BRID, KC_BRIU, KC_F13,  KC_F14,  BL_DEC,  BL_INC,  KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU,           XXXXXXX, RGB_TOG,   TG(2), \
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSPC, XXXXXXX, XXXXXXX, XXXXXXX, \
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,  KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, \
        KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                             KC_UP, \
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,                             KC_LGUI, MO(1),   KC_APP,            KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT \
    )      
    /*
    [2] = LAYOUT(
...
//
// Mode 1 is default red
// Mode 2 is common testpattern
// Start at mode 3.
//
